...
import "../styles/explainer-centered.css";
...
export default function ExplainerPage() {
  ...
  return (
    <div className="explainer-mode-centered">
      <section className="explainer-main-centered">
        {!currentPage ? (
          <div className="explainer-upload-section">
            {/* Tabs */}
            ...
            {/* Upload Tab Content */}
            <div className="upload-content" style={{ display: activeTab === "upload" ? "flex" : "none" }}>
              <div className="upload-icon">
                <Upload size={48} strokeWidth={1.5} />
              </div>
              <h2>Upload Outfit Image</h2>
              <p className="upload-hint">Click to select or drag and drop</p>
              ...
              <p className="upload-formats">PNG, JPG, JPEG · Up to 50MB</p>

              {/* Settings */}
              <div className="upload-settings">
                <div className="control-group">
                  <label htmlFor="vision-model">AI Model</label>
                  <select
                    id="vision-model"
                    value={visionModel}
                ...
                <div className="control-group">
                  <label htmlFor="grounding-mode">Detection Mode</label>
                  <select
                    id="grounding-mode"
                    value={groundingMode}
            ...
            <div className="generate-content" style={{ display: activeTab === "generate" ? "flex" : "none" }}>
              <div className="generate-icon">
                <Wand2 size={48} strokeWidth={1.5} />
              </div>
              <h2>Generate from Prompt</h2>
              <p className="generate-hint">Describe what you want to explore</p>

              <div className="topic-row-centered">
                <textarea
                  value={topic}
                  onChange={(e) => setTopic(e.target.value)}
                  placeholder="E.g., 'How a smartphone works', 'Anatomy of a shoe'"
                  onKeyDown={(e) => e.key === "Enter" && e.ctrlKey && handleTopicStart()}
                  disabled={phase !== "idle"}
              ...
              <button
                ...
                disabled={phase !== "idle"}
                title="Generate detailed explanation (Ctrl+Enter)"
              >
              ...
              <div className="upload-settings">
                <div className="control-group">
                  <label htmlFor="vision-model-gen">AI Model</label>
                  <select
                    id="vision-model-gen"
                    value={visionModel}
                    onChange={(e) => setVisionModel(e.target.value as VisionModelKey)}
                ...
                <div className="control-group">
                  <label htmlFor="grounding-mode-gen">Detection Mode</label>
                  <select
                    id="grounding-mode-gen"
                    value={groundingMode}
                    onChange={(e) => setGroundingMode(e.target.value as GroundingMode)}
                    disabled={phase !== "idle"}
                  >
