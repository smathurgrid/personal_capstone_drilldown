...
export default function EcommercePage() {
  ...
  return (
    <div className="flex h-full min-h-[calc(100vh-64px)] bg-[#0a0a0a] overflow-hidden relative">
      {currentImage && (
        <button
          type="button"
          onClick={handleHome}
          className="absolute top-6 left-6 z-40 p-2.5 bg-[rgba(255,107,53,0.1)] hover:bg-[rgba(255,107,53,0.15)] rounded-lg border border-[#2d3c5e] text-[#ff6b35] transition-all"
