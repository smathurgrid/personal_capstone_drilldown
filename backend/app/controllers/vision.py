...
from backend.shared.ollama_health import ollama_reachable, require_ollama


def get_vision_module_status() -> dict:
    static_ready = settings.EXPLAINER_STATIC_DIR.exists()
    ollama_ok = ollama_reachable()
    needs_ollama = settings.MODEL_PROVIDER != "mock"
    return {
        "module": "explainer-vision",
        "stage": settings.STAGE,
        "ready": static_ready and (ollama_ok or not needs_ollama),
