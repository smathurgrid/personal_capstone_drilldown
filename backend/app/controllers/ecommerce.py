...
def get_ecommerce_module_status(product_search: ProductSearch | None = None) -> dict:
    ...
    search_ok = product_search is not None
    search_err = None

    return {
        "module": "ecommerce",
        "stage": settings.STAGE,
        "ready": qdrant_ready and dataset_ready and bool(settings.GOOGLE_API_KEY),
        "source": "ecommerce",
        "checks": {
            ...
            "search_service_deferred": product_search is None,
